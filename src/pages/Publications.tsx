        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <ul className="list-disc list-inside text-academic-secondary">
              ...
              <li className="mb-4">
                <strong>Model for current drive induced crash cycles in W7-X</strong>
                <br />
                <span className="text-gray-600">K Aleynikova, SR Hudson, P Helander, <strong className="text-blue-600">A. Kumar</strong>, J Geiger, M Hirsch, ...</span>
                <br />
                <span className="italic">Nuclear Fusion 61 (12), 126040</span>
              </li>
              ...
              <li className="mb-4">
                <strong>Overview of the first Wendelstein 7-X long pulse campaign with fully water-cooled plasma facing components</strong>
                <br />
                <span className="text-gray-600">O Grulke, C Albert, JAA Belloso, P Aleynikov, K Aleynikova, A Alonso, <strong className="text-blue-600">A. Kumar</strong>, ...</span>
                <br />
                <span className="italic">Nuclear Fusion 64 (11), 112002</span>
              </li>
              ...
              <li className="mb-4">
                ...
                <br />
                <span className="text-gray-600">S Benjamin, C Clause, C Rea, R Sweeney, <strong className="text-blue-600">A. Kumar</strong>, E Marmar</span>
                <br />
